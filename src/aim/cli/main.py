...
def init_framework() -> None:
    ...
    parser = argparse.ArgumentParser(description="Initialize a new AIM Framework project")
    parser.add_argument(
        "project_name",
        type=str,
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="AIM Framework Command Line Interface",
        prog="aim"
    )
    ...
    # Server command
    server_parser = subparsers.add_parser("server", help="Start the AIM Framework server")
